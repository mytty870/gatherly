...
export const ZennFullIcon = (props: IconBaseProps) => {
  return (
    // <IconBase viewBox="0 0 80 88" width="18" height="18" title="zenn-icon" fill="#3EA8FF" {...props}>
    <IconBase viewBox="0 0 377.4 88.3" width="50" title="zenn-icon" {...props}>
      <g fill="#111">
